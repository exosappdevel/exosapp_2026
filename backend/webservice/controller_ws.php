...
class WebServiceController
{
    ...
    private $metodos_info = [
        ...
        'get_hospitales' => [
            'descripcion' => 'Obtiene listado de hospitales por id_almacen, id_usuario',
        ...
        "next_codigo_cirugia" => [
            'descripcion' => 'Obtiene el sgte num de cirugia',
            'parameters' => ["id_almacen"],
        ],
        "guardar_cirugia" => [
        ...
        "piezas_danadas_reporte_estatus" =>[
            'descripcion' =>'Obtiene la lista de estatus de reporte de piezas dañadas',
            'parameters' => ["show_todos"]
        ],
    ...
    public function piezas_danadas_reporte_estatus(){
        ...
        $show_todos  = Requesting("show_todos");
        if ($show_todos == "")
            $show_todos  = "1";
        // ELSE USE NEXT MOCKUP
