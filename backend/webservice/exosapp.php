...
class ExosApp_WS
{
    ...
    public function app_perfiles_usuario_add(){
     ...
     // Lista los id_usuario_app ya asignados a un perfil (inverso de app_perfiles_usuario_get,
     // que hace la búsqueda por usuario). Necesario para la UI de "agregar/quitar usuarios
     // a un perfil" ya que app_perfiles_usuarios no tenía consulta por id_perfil.
